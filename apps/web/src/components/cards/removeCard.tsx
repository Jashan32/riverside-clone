...
export default function RemoveCard({ title, setRemoveCardState }: { title: string, setRemoveCardState: (state: boolean) => void }) {
    ...
    return (
        <div ref={removeCardRef} className="w-[460px] h-[362px] bg-[#222222] rounded-[16px] m-[32px] p-[28px] pb-[0px]">
            <div className="text-[20px] font-extrabold  pb-[16px]">Remove project?</div>
            <div>
            ...
            <div className="py-[28px] flex justify-end w-[396px]">
                <div className="flex gap-[16px]">
                    <button className="text-[14px] py-[12px] px-[18px] rounded-[8px] cursor-pointer hover:bg-[#383838]">Cancel</button>
                    <button className="text-[14px] py-[12px] px-[18px] rounded-[8px] cursor-pointer bg-[#e04040] hover:bg-[#b93e37]">Remove</button>
                </div>
            </div>
        </div>
    );
