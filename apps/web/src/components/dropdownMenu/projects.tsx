...
export default function ProjectsDropdown({ setRemoveCardState, setDropDownState, projectId, setRemoveProjectId }: { setRemoveCardState: (state: boolean) => void, setDropDownState: (state: boolean) => void, projectId: string, setRemoveProjectId: (id: string | null) => void }) {
    return (
        <div className="select-none flex flex-col gap-[4px] w-[204px] h-[204px] p-[8px] bg-[#2b2b2b] rounded-[12px]">
            ...
            <div className="flex gap-[12px] w-[188px] h-[44px] py-[10px] px-[16px] hover:bg-[#383838] cursor-pointer rounded-[8px]"
                onClick={() => { setRemoveCardState(true); setDropDownState(false); setRemoveProjectId(projectId) }}>
