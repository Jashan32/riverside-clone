...
export default function Schedule() {
    ...
    return (
        <div className="px-[60px] pt-[60px] h-full">
            ...
            {
                (isUpcomingSort ? upcomingSessions : previousSessions)?.length <= 0 ? <div className="w-full h-full flex flex-col items-center justify-center">
                    <CurrentDateCard />
                    <div className="text-[20px] font-extrabold mt-[24px]">No {isUpcomingSort ? "upcoming" : "past"} sessions</div>
