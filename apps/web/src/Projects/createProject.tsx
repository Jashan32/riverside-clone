...
export default function CreateProject({isAlredyCreated, id, name}:{isAlredyCreated?:boolean, id?:string, name?:string}) {
    return (
        <div className="max-w-[100%]">
            <CreateProjectHeader isAlredyCreated={isAlredyCreated} id={id} name={name} />
            <div className="pt-[88px] flex flex-col items-center max-w-[100%]">
                ...
                <div className="max-w-[100%] px-[40px] flex items-center justify-center">
                    ...
                    <FeatureCard projectId={id} text1="Plan" text2="Schedule and invite guests."/>
