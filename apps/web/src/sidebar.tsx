    ...
    return (
        <div className={` text-white flex flex-col gap-[12px] transition-[width] duration-300 ${isOpen ? " w-[232px]" : "w-[68px]"} h-[100vh] m-[8px] mr-0`}>
            <div className={`text-lg font-bold h-[40px] flex items-center ${isOpen?"justify-between ml-[12px]":"justify-center ml-[0px]"}`}>
                ...
                <div className="flex hover:bg-[#1d1d1d] rounded-[8px] " onClick={() => { setIsOpen(!isOpen); localStorage.setItem('isOpen', `${!isOpen}`) }}>
            ...
            <div>
                <div className={`flex flex-col gap-[4px] [&>div]:flex [&>div]:gap-[8px] [&>div]:items-center [&>div]:hover:bg-[#1d1d1d] [&>div]:cursor-pointer [&>div]:rounded-[8px] ${isOpen ? "[&>div]:h-[40px]" : "[&>div]:h-[68px]"} [&>div]:py-[12px] [&>div]:px-[16px]`}>
                    <div className={`${isOpen ? "" : "flex flex-col"} ${currentTab === "home" ? "bg-[#1d1d1d]" : ""}`}
                    ...
                    <div className={`${isOpen ? "" : "flex flex-col"} ${currentTab === "project" ? "bg-[#1d1d1d]" : ""}` }
                    ...
                    <div className={`${isOpen ? "" : "flex flex-col"} ${currentTab === "schedule" ? "bg-[#1d1d1d]" : ""}`}
